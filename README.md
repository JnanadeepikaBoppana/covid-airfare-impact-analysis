...
---
How to Run
Click the Tableau Public link above to view the dashboard instantly in your browser — no installation needed
Or download `dashboard/COVID_Airfare_Dashboard.twbx` and open in Tableau Desktop
Navigate through the dashboard to explore each visualization
---
